		...
		for (int contY = 0; contY < x; contY++) {
			for (int contX = 0; contX < y; contX++) {
				if (contX == contM && contY == contN
						&& (arreglochar[contM][contN] == 'C' || arreglochar[contM][contN] == 0)) {
					ImageIcon jugador = new ImageIcon(getClass().getResource("/imagenes/messifinal.jpg"));
					Icon icono = new ImageIcon(
							jugador.getImage().getScaledInstance(btn2.getMaximumSize().width * (x + x),
					...
					arreglochar[contM][contN] = 'J';
						...
						&& (arreglochar[contS][contT] == 'C' || arreglochar[contS][contT] == 0)) {

					ImageIcon balon = new ImageIcon(getClass().getResource("/imagenes/balon.png"));
					Icon icono2 = new ImageIcon(
							balon.getImage().getScaledInstance(btn3.getMaximumSize().width * (x + x),
				...
				} else if (contX == contA && contY == contB
						&& (arreglochar[contA][contB] == 'C' || arreglochar[contA][contB] == 0)) {
					...
					for (int c = 0; c < t; c++) {
						if (arreglochar[contA][contB] == 'C' || arreglochar[contA][contB] == 0) {
							...
							Icon icono3 = new ImageIcon(
									enemigo.getImage().getScaledInstance(btn4.getMaximumSize().width * (x + x),
				...
				} else if (contX == contC && contY == contD
						&& (arreglochar[contC][contD] == 'C' || arreglochar[contC][contD] == 0)) {
					...
					for (int c = 0; c < o; c++) {
						if (arreglochar[contC][contD] == 'C' || arreglochar[contC][contD] == 0) {
							...
							Icon copa = new ImageIcon(
									objetivo.getImage().getScaledInstance(btn6.getMaximumSize().width * (x + x),
				...
				} else if (contX == contP && contY == contQ
						&& (arreglochar[contP][contQ] == 'C' || arreglochar[contP][contQ] == 0)) {
					for (int a = 0; a < l; a++) {
						if (arreglochar[contP][contQ] == 'C' || arreglochar[contP][contQ] == 0) {
							...
							Icon icono5 = new ImageIcon(
									enemigo2.getImage().getScaledInstance(btn5.getMaximumSize().width * (x + x),
				...
				} else if (contX == cont1 && contY == cont2
						&& (arreglochar[cont1][cont2] == 'C' || arreglochar[cont1][cont2] == 0)) {
					for (int f = 0; f < m; f++) {
						if (arreglochar[cont1][cont2] == 'C' || arreglochar[cont1][cont2] == 0) {
							...
							Icon icono7 = new ImageIcon(
									muro.getImage().getScaledInstance(btn7.getMaximumSize().width * (x + x),
					...
					cont2 = -1;
						...
						&& (arreglochar[contX][contY] == 'C' || arreglochar[contX][contY] == 0)) {
					btn = new JButton();
	...
	public void keyPressed(KeyEvent e) {
		...
		if (pasos > 0) {
			...
			if ((contM != 0 && contN != 0) && (contM != arreglochar.length - 1 && contN != arreglochar.length - 1)) {
				if (arreglochar[contM - 1][contN] == 'L' || arreglochar[contM + 1][contN] == 'L'
						|| arreglochar[contM][contN - 1] == 'L' || arreglochar[contM][contN + 1] == 'L') {
					pasos = 0;
				} else if (arreglochar[contM - 1][contN] == 'T' || arreglochar[contM + 1][contN] == 'T'
						|| arreglochar[contM][contN - 1] == 'T' || arreglochar[contM][contN + 1] == 'T') {
					pasos = pasos - 5;
				}
			} else if ((contM == 0 && contN != 0)
					&& (contM != arreglochar.length - 1 && contN != arreglochar.length - 1)) {
				if (arreglochar[contM + 1][contN] == 'L' || arreglochar[contM][contN - 1] == 'L'
						|| arreglochar[contM][contN + 1] == 'L') {
					pasos = 0;
				} else if (arreglochar[contM + 1][contN] == 'T' || arreglochar[contM][contN - 1] == 'T'
						|| arreglochar[contM][contN + 1] == 'T') {
					pasos = pasos - 5;
				}
			} else if ((contM != 0 && contN == 0)
					&& (contM != arreglochar.length - 1 && contN != arreglochar.length - 1)) {
				...
				if (arreglochar[contM - 1][contN] == 'L' || arreglochar[contM][contN - 1] == 'L'
					...
					if (arreglochar[contM - 1][contN] == 'L' || arreglochar[contM][contN - 1] == 'L'
							|| arreglochar[contM + 1][contN] == 'L') {
						pasos = 0;
					} else if (arreglochar[contM - 1][contN] == 'T' || arreglochar[contM][contN - 1] == 'T'
							|| arreglochar[contM + 1][contN] == 'T') {
						pasos = pasos - 5;
					}
				} else if (contM == arreglochar.length - 1 && contN == arreglochar.length - 1) {

					if (arreglochar[contM - 1][contN] == 'L' || arreglochar[contM][contN - 1] == 'L'
							|| arreglochar[contM + 1][contN] == 'L' || arreglochar[contM][contN + 1] == 'L') {
						pasos = 0;
					} else if (arreglochar[contM - 1][contN] == 'T' || arreglochar[contM][contN - 1] == 'T'
							|| arreglochar[contM + 1][contN] == 'T' || arreglochar[contM][contN + 1] == 'T') {
						pasos = pasos - 5;
					}
				}
			}
			...
			if (m == KeyEvent.VK_UP) {
				...
				/*
				 * TODO:-Movimientos de las bestias Quitar vida si toca a cristiano Pierde juego
				 * si toca a Ramos Agregar los muros
				 */
