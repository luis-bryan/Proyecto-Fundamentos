...
public class Ayudas extends JPanel {
  ...
  public Ayudas() {
    ...
    contadorPuntos = new JLabel("PUNTOS OBTENIDOS: 0");
    add(contadorPuntos).setBounds(30,10,150,150);
    add(contador).setBounds(30, 10, 150, 30);
  ...
  public JLabel getContadorPuntos() {
    return contadorPuntos;
  }

  public void setContadorPuntos(JLabel contadorPuntos) {
